		...
		.invoke_handler(|webview, arg| {
			match arg {
				"open" => match tfd::open_file_dialog("Please choose a file...", "", None) {
					...
					None => tfd::message_box_ok("Warning", "You didn't choose a file.", MessageBoxIcon::Warning),
				},
				"save" => match tfd::save_file_dialog("Save file...", "") {
					Some(path) => tfd::message_box_ok("File chosen", &path, MessageBoxIcon::Info),
					None => tfd::message_box_ok("Warning", "You didn't choose a file.", MessageBoxIcon::Warning),
				},
				"info" => tfd::message_box_ok("Info", "This is a info dialog", MessageBoxIcon::Info),
				"warning" => tfd::message_box_ok("Warning", "This is a warning dialog", MessageBoxIcon::Warning),
				"error" => tfd::message_box_ok("Error", "This is a error dialog", MessageBoxIcon::Error),
				"exit" => webview.exit(),
				_ => unimplemented!(),
			};
